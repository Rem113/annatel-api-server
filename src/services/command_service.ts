...
// TODO: Document
const validateParams = (actionType: any, params: any) => {
...
const mapActionToObject = (watch: any, actionType: any, params: any) => {
  const isValid = validateParams(actionType, params);
